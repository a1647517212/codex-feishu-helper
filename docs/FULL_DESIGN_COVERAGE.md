...
| 16 Change and log display | Partial | Event/log cards, task status cards, sanitized summaries, progress cards, local task detail pages, and non-Git “本次影响” cards exist. | Advanced paging can improve. |
